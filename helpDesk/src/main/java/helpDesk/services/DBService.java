...
public class DBService {
	...
	public void instanciaDB() {
		Tecnico t1 = new Tecnico(null, "Marcus Aurelio", "66118108030", "Marcus@email.com", encoder.encode("123"));
		t1.addPerfil(Perfil.Admin);
		Tecnico t2 = new Tecnico(null, "Maria dos Santos", "07253648072", "Maria@email.com", encoder.encode("123"));
		t1.addPerfil(Perfil.Tecnico);
		Tecnico t3 = new Tecnico(null, "Karem Amanda", "53260129014", "karem@email.com", encoder.encode("123"));
		t1.addPerfil(Perfil.Tecnico);
		Tecnico t4 = new Tecnico(null, "Jose da Silva", "38047769065", "Jose@email.com", encoder.encode("123"));
		t1.addPerfil(Perfil.Admin);
		
		
		Cliente c1 = new Cliente(null, "Josepe Novo", "57279112064", "josepe@email.com", encoder.encode("123"));
		Cliente c2 = new Cliente(null, "Fernando", "42595924087", "fernando@email.com", encoder.encode("123"));
		Cliente c3 = new Cliente(null, "Maria", "03534217071", "maria@email.com", encoder.encode("123"));
		Cliente c4 = new Cliente(null, "Helena", "99676774065", "helena@email.com", encoder.encode("123"));
